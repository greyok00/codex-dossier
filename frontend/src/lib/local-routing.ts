  ...
  if (policeMisconductCase || categories.includes("civil_rights")) {
    routes.push({
      recommendation: {
        ...
        mailing_address: null,
        intake_methods_snapshot: ["web_form"],
        required_documents_snapshot: ["Dossier summary", "Dates", "Agency or officer details", "Proof packet"],
        available_actions: ["open_form", "share_packet", "export_packet", "save_for_later"],
        selected: false,
      },
      priority: 72,
  ...
  return [
    {
      recommendation: {
        ...
        required_documents_snapshot: ["Dossier summary", "Date and time", "Officer details if known", "Proof packet"],
