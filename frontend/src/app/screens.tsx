...
export function PrepareLocalAiScreen({
  ...
  const localSetupDetail = usesNativeShell
    ? "First setup verifies the bundled speech and writing tools and finishes device setup. The first transcript and first draft load them on this device."
  ...
  const localAiGuideItems = usesNativeShell
    ? [
        ...
        "Writing tools are bundled into the app and finish loading when you open the first draft.",
